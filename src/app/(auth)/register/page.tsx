...
import { collection, query, type DocumentData, onSnapshot } from 'firebase/firestore';
...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const isSuperAdminEmailCheck = email.toLowerCase() === 'vallrack67@gmail.com';

    if (!role && !isSuperAdminEmailCheck) {
      toast({
        variant: 'destructive',
        title: 'Campo Requerido',
        description: 'Por favor, selecciona si eres Estudiante o Profesor.',
      });
      return;
    }
    ...
    try {
      const finalRole: UserRole = isSuperAdminEmailCheck ? 'SUPER_ADMIN' : role as UserRole;
