    ...
    const fetchChallenge = async () => {
      ...
      try {
        ...
        if (challengeDocSnap.exists()) {
          ...
          setMaxAttempts(data.maxAttempts === null || data.maxAttempts === undefined ? '' : data.maxAttempts);
        } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="grid gap-3">
                    ...
                    <Input
                        ...
                        placeholder="ej. 3"
                    />
                    <p className="text-sm text-muted-foreground">Deja en blanco o pon 0 para intentos ilimitados.</p>
                </div>
            </div>
            <div className="grid gap-3">
